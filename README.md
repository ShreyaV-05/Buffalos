...
| --- | --- | --- | --- | --- |
| Coming Soon Page | Andrea | Page with table of cuisines, user can create/add a cuisine to the list. Later will filter the data so there will be options to only view cuisines of a certain location or a certain price. | frontend form: https://github.com/ShreyaV-05/Buffalos/blob/main/templates/coming_soon.html, establishing table and creating database: https://github.com/ShreyaV-05/Buffalos/blob/main/app.py#L63-L84, showing old items and adding items into table: https://github.com/ShreyaV-05/Buffalos/blob/main/app.py#L246-L268  | https://github.com/ShreyaV-05/Buffalos/projects/1#card-53804462, and https://github.com/ShreyaV-05/Buffalos/projects/1#card-54323634 |
